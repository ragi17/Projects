...
export default class KotiMeas extends Component {
  constructor(props) 
  {
      super(props);
      this.state = 
  ...
  measurement() {
    if(this.state.chest && this.state.waist && this.state.hips && this.state.armlen && this.state.armhole && this.state.forearm && this.state.shoulder && this.state.wrist && this.state.forearm  && this.state.suitlen  === "" ) {
  ...
  { 
    return(  
      ...
      <TextInput keyboardType='numeric' placeholder='Chest' style={measstyles.shoulder}onChangeText={(Text) => this.setState({chest: Text})} value={this.state.neck}/>
      <TextInput keyboardType='numeric' placeholder='Waist' style={measstyles.shoulder}onChangeText={(Text) => this.setState({waist: Text})} value={this.state.neck}/>
      <TextInput keyboardType='numeric' placeholder='Hips' style={measstyles.shoulder}onChangeText={(Text) => this.setState({hips: Text})} value={this.state.neck}/>
      <TextInput keyboardType='numeric' placeholder='Collar' style={measstyles.shoulder}onChangeText={(Text) => this.setState({collar: Text})} value={this.state.neck}/>
      <TextInput keyboardType='numeric' placeholder='Arm Length' style={measstyles.shoulder}onChangeText={(Text) => this.setState({armlen: Text})} value={this.state.neck}/>
      <TextInput keyboardType='numeric' placeholder='Arm Hole' style={measstyles.shoulder}onChangeText={(Text) => this.setState({armhole: Text})} value={this.state.neck}/>
      <TextInput keyboardType='numeric' placeholder='Shoulder' style={measstyles.shoulder}onChangeText={(Text) => this.setState({shoulder: Text})} value={this.state.neck}/>
      <TextInput keyboardType='numeric' placeholder='Wrist' style={measstyles.shoulder}onChangeText={(Text) => this.setState({wrist: Text})} value={this.state.neck}/>
      <TextInput keyboardType='numeric' placeholder='Forearm' style={measstyles.shoulder}onChangeText={(Text) => this.setState({forearm: Text})} value={this.state.neck}/>
      <TextInput keyboardType='numeric' placeholder='Suit Length' style={measstyles.shoulder}onChangeText={(Text) => this.setState({suitlen: Text})} value={this.state.neck}/>
