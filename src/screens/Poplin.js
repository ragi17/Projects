...
export default class Poplin extends Component {
  constructor(props) 
  {
      super(props);
      this.state = 
  ...
  { 
    return(  
      ...
      <View>
        <View>
          <Image style={fabricstyles.img} source={require('../assets/poplin.jpg')}></Image>
        </View>   
            <Text style={fabricstyles.rupee}>₹199</Text>
            <Text style={fabricstyles.ps}>Product Specification</Text>
            <Text style={fabricstyles.pt}>Product Name: Poplin Fabric</Text>
