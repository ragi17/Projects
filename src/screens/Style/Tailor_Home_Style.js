...
(
    ...
    order:
    {
      height:60,width:'90%',alignSelf:'center',borderColor:'#000000',borderWidth:2,borderRadius:10
    },
    arrow:
    {
      height:20,width:25,marginLeft:310,marginTop:-23
    },
    name:
    {
      fontSize:22,color:'#000000',marginLeft:64,marginTop:-40
    },
    pro:
    {
      height:40,width:45,margin:6
    },
    upper: 
    {
    ...
    centertext: {
      marginLeft: 35,marginTop:20, fontWeight: 'bold', color: '#000000', fontFamily: 'sans-serif-light', fontSize:20
    },
    centerendtext: {
      marginLeft: 330,marginBottom:15,marginTop:-20, fontWeight: 'bold', color: '#000000', fontFamily: 'sans-serif-light', fontSize:15, textDecorationLine:'underline'
    },
    centereendtext: {
      marginLeft: 330,marginBottom:15,marginTop:-35, fontWeight: 'bold', color: '#000000', fontFamily: 'sans-serif-light', fontSize:15, textDecorationLine:'underline'
    },
    fabric1:{
    ...
    category_trouser: {
      height:120, width:120, marginLeft:45,marginTop:15, borderRadius:30
    },
    category_shirt: {
