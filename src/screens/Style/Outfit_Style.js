...
(
    {
        ...
        stock: {
          fontSize:22,fontFamily:'sans-serif-light',paddingLeft:20,paddingBottom:50,marginTop:10,color:"#3CB371",fontWeight:"bold"
        },
        buystitch: {
        ...
        buy: {
          backgroundColor: "#5FBEBC",width:"100%",alignContent:"center",alignItems:"center",paddingTop:8,paddingBottom:20,marginBottom:20,borderColor:"#000000",borderTopWidth:1.5
        },
        buystitchtext: {
