...
export default class Georgette extends Component {
  constructor(props) 
  {
      super(props);
      this.state = 
  ...
  { 
    return(  
      ...
      <View>
        <View>
          <Image style={fabricstyles.img} source={require('../assets/georgette.jpg')}></Image>
        </View>   
            <Text style={fabricstyles.rupee}>₹120</Text>
            <Text style={fabricstyles.ps}>Product Specification</Text>
            <Text style={fabricstyles.pt}>Product Name: Georgette Fabric</Text>
