...
export default class Jacket extends Component {
  ...
  { 
    return(  
      ...
      <View>
        <View>
          <Image style={outfitstyles.img} source={require('../assets/gjacket.jpg')}></Image>
        </View>   
            <Text style={outfitstyles.rupee}>₹500</Text>
            <Text style={outfitstyles.ps}>Product Specification</Text>
            <Text style={outfitstyles.pt}>Product Name: Jacket</Text>
            <Text style={outfitstyles.pt}>Product Type: Clothing</Text>
            <Text style={outfitstyles.stock}>In Stock</Text>
        <View>
            <TouchableOpacity style={outfitstyles.buy} onPress={() => this.props.navigation.navigate("JacketMeas")}>
