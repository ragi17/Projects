...
export default class LehangaMeas extends Component {
  constructor(props) 
  {
      super(props);
      this.state = 
  ...
  measurement() {
    if(this.state.neck && this.state.ubust && this.state.bust && this.state.obust && this.state.aroundbicep && this.state.waist && this.state.armlen && this.state.armhole && this.state.forearm && this.state.wrist && this.state.shoulder && this.state.wtoankle && this.state.stowaist  === "" ) {
