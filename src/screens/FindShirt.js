...
export default class FindShirt extends Component {
  constructor(props) 
  {
      super(props);
      this.state = 
  ...
  componentDidMount() {
    ...
    firestore().collection('Customer').doc(id.uid).get().then((docRef) => {
      // let name=docRef.data().Name;
        ...
        this.setState({Seat: docRef.data().Seat}),
        this.setState({Length: docRef.data().Lngth}),
        ...
        this.setState({Cuff: docRef.data().Cuff})
      });
    console.log(id.uid)
