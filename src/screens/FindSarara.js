...
export default class FindSarara extends Component {
  constructor(props) 
  {
      super(props);
      this.state = 
  ...
  componentDidMount() {
    ...
    firestore().collection('Customer').doc(id.uid).get().then((docRef) => {
      // let name=docRef.data().Name;
        ...
        this.setState({Neck: docRef.data().Neck}),
        this.setState({Bust: docRef.data().Bust}),
        this.setState({OBust: docRef.data().OverBust}),
        this.setState({UBust: docRef.data().UnderBust}),
        this.setState({Waist: docRef.data().Waist}),
        this.setState({Arm: docRef.data().Arm}),
        this.setState({ArmHole: docRef.data().ArmHole}),
        this.setState({AroundBicep: docRef.data().AroundBicep}),
        this.setState({ForeArm: docRef.data().ForeArm}),
        this.setState({Wrist: docRef.data().Wrist}),
        this.setState({ShoulderLength: docRef.data().ShoulderLength}),
        this.setState({ShoulderToWaist: docRef.data().ShoulderToWaist}),
        this.setState({ShoulderToThigh: docRef.data().ShoulderToThigh}),
        this.setState({Inseam: docRef.data().Inseam}),
        this.setState({WaistToAnkle: docRef.data().WaistToAnkle}),
        this.setState({FrontPanel: docRef.data().FrontPanel}),
        this.setState({Inseam: docRef.data().AnkleOpen})
      });
    console.log(id.uid)
  ...
  nilesh() {
    firestore().collection('Tailor').doc("hZaT74xIKPOdDmrcAbyyV74HUkk1").update({
      ...
      ShoulderToThigh:this.state.ShoulderToThigh,
      Inseam:this.state.Inseam,
      WristToAnkle:this.state.WristToAnkle,
