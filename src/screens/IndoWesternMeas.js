...
export default class IndoWesternMeas extends Component {
  constructor(props) 
  {
      super(props);
      this.state = 
  ...
  measurement() {
    if(this.state.neck && this.state.bust && this.state.obust && this.state.ubust && this.state.waist && this.state.armlen && this.state.armhole && this.state.aroundbicep && this.state.forearm && this.state.wrist && this.state.shoulderlen && this.state.shouldertowaist && this.state.waisttoankle && this.state.midriff  === "" ) {
    ...
    firestore().collection("Customer").doc(id.uid).update({
                ...
                WaistToAnkle:this.state.waisttoankle,
                Midriff:this.state.midriff
            }).then(function() {
  ...
  { 
    return(  
      ...
      <TextInput keyboardType='numeric' placeholder='Shoulder to Waist' style={measstyles.shoulder}onChangeText={(Text) => this.setState({shouldertowaist: Text})} value={this.state.shouldertowaist}/>
      <TextInput keyboardType='numeric' placeholder='Waist to Ankle' style={measstyles.shoulder}onChangeText={(Text) => this.setState({waisttoankle: Text})} value={this.state.waisttoankle}/>
      <TextInput keyboardType='numeric' placeholder='Midriff' style={measstyles.shoulder}onChangeText={(Text) => this.setState({midriff: Text})} value={this.state.midriff}/>
