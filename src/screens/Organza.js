...
export default class Organza extends Component {
  constructor(props) 
  {
      super(props);
      this.state = 
  ...
  { 
    return(  
      ...
      <View>
        <View>
          <Image style={fabricstyles.img} source={require('../assets/organza.jpg')}></Image>
        </View>   
            <Text style={fabricstyles.rupee}>₹110</Text>
            <Text style={fabricstyles.ps}>Product Specification</Text>
            <Text style={fabricstyles.pt}>Product Name: Organza Fabric</Text>
