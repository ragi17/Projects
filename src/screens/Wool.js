...
export default class Wool extends Component {
  constructor(props) 
  {
      super(props);
      this.state = 
  ...
  { 
    return(  
      ...
      <View>
        <View>
          <Image style={fabricstyles.img} source={require('../assets/wool.jpg')}></Image>
        </View>   
            <Text style={fabricstyles.rupee}>₹245</Text>
            <Text style={fabricstyles.ps}>Product Specification</Text>
            <Text style={fabricstyles.pt}>Product Name: Wool Fabric</Text>
