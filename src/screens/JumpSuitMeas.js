...
export default class JumpSuitMeas extends Component {
  constructor(props) 
  {
      super(props);
      this.state = 
  ...
  measurement() {
    if(this.state.neck && this.state.bust && this.state.obust && this.state.ubust && this.state.waist && this.state.arm && this.state.armhole && this.state.aroundbicep && this.state.wrist && this.state.forearm && this.state.shoulderlen && this.state.hips && this.state.wtoankle && this.state.inseam && this.state.ankleopen  === "" ) {
